...
public class Inventories {
    ...
    public InventoryConfig islandBiomes = new InventoryConfig(45, "&7Island Biomes", background1, ImmutableMap.<String, Item>builder()
            ...
            .put("is biomes bamboo_jungle", new Item(XMaterial.BAMBOO, 1, 1, "&c&lBamboo Jungle", Collections.emptyList()))
            .put("is biomes beach", new Item(XMaterial.TURTLE_EGG, 2, 1, "&c&lBeach", Collections.emptyList()))
            .put("is biomes dark_forest", new Item(XMaterial.DARK_OAK_LOG, 3, 1, "&c&lDark Forest", Collections.emptyList()))
            .put("is biomes deep_ocean", new Item(XMaterial.PRISMARINE_SHARD, 4, 1, "&c&lDeep Ocean", Collections.emptyList()))
            .put("is biomes deep_warm_ocean", new Item(XMaterial.BRAIN_CORAL, 5, 1, "&c&lDeep Warm Ocean", Collections.emptyList()))
            .put("is biomes desert", new Item(XMaterial.SAND, 6, 1, "&c&lDesert", Collections.emptyList()))
            .put("is biomes forest", new Item(XMaterial.BIRCH_LOG, 10, 1, "&c&lForest", Collections.emptyList()))
            .put("is biomes frozen_ocean", new Item(XMaterial.ICE, 12, 1, "&c&lFrozen Ocean", Collections.emptyList()))
            .put("is biomes ice_spikes", new Item(XMaterial.PACKED_ICE, 14, 1, "&c&lIce Spikes", Collections.emptyList()))
            .put("is biomes jungle", new Item(XMaterial.JUNGLE_LOG, 16, 1, "&c&lJungle", Collections.emptyList()))
            .put("is biomes lukewarm_ocean", new Item(XMaterial.FIRE_CORAL, 18, 1, "&c&lLukewarm Ocean", Collections.emptyList()))
            .put("is biomes mountains", new Item(XMaterial.STONE, 20, 1, "&c&lMountains", Collections.emptyList()))
            .put("is biomes mushroom_fields", new Item(XMaterial.RED_MUSHROOM_BLOCK, 22, 1, "&c&lMushroom Fields", Collections.emptyList()))
            .put("is biomes ocean", new Item(XMaterial.HORN_CORAL, 24, 1, "&c&lOcean", Collections.emptyList()))
            .put("is biomes plains", new Item(XMaterial.GRASS_BLOCK, 26, 1, "&c&lPlains", Collections.emptyList()))
            .put("is biomes river", new Item(XMaterial.SEAGRASS, 28, 1, "&c&lRiver", Collections.emptyList()))
            .put("is biomes savanna", new Item(XMaterial.ACACIA_LOG, 30, 1, "&c&lSavanna", Collections.emptyList()))
            .put("is biomes snowy_mountains", new Item(XMaterial.SNOWBALL, 32, 1, "&c&lSnowy Mountains", Collections.emptyList()))
            .put("is biomes swamp", new Item(XMaterial.VINE, 34, 1, "&c&lSwamp", Collections.emptyList()))
            .put("is biomes taiga", new Item(XMaterial.SPRUCE_LOG, 36, 1, "&c&lTaiga", Collections.emptyList()))
            .put("is biomes warm_ocean", new Item(XMaterial.TUBE_CORAL, 38, 1, "&c&lWarm Ocean", Collections.emptyList()))
            .put("is biomes wooded_hills", new Item(XMaterial.OAK_LOG, 40, 1, "&c&lWooded Hills", Collections.emptyList()))
            .put("is biomes the_end", new Item(XMaterial.END_STONE, 42, 1, "&c&lThe End", Collections.emptyList()))
            .put("is biomes the_nether", new Item(XMaterial.NETHERRACK, 44, 1, "&c&lNether Wastelands", Collections.emptyList()))
            .build()
    );
