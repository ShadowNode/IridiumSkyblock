...
public class Permissions {
    ...
    public Permission border = new Permission(new Item(XMaterial.BEACON, 34, 1, "&bIsland Border", Arrays.asList("&7Grant the ability to Change the Island border.", "", "&b&lPermission", "%permission%")), IslandRank.TRUSTED);
