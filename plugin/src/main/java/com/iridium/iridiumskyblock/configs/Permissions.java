...
public class Permissions {
    ...
    public Permission pickupItems = new Permission(new Item(XMaterial.HOPPER, 26, 1, "&bPickup Items", Arrays.asList("&7Grant the ability to pickup items on your island.", "", "&b&lPermission", "%permission%")), IslandRank.TRUSTED);
    public Permission dropItems = new Permission(new Item(XMaterial.GHAST_TEAR, 27, 1, "&bDrop Items", Arrays.asList("&7Grant the ability to drop items on your island.", "", "&b&lPermission", "%permission%")), IslandRank.TRUSTED);
    public Permission interactEntities = new Permission(new Item(XMaterial.CREEPER_HEAD, 28, 1, "&bInteract with Entities", Arrays.asList("&7Grant the ability to interact with entities on your island.", "", "&b&lPermission", "%permission%")), IslandRank.TRUSTED);
    public Permission trust = new Permission(new Item(XMaterial.EMERALD, 29, 1, "&bTrust Users", Arrays.asList("&7Grant the ability to manage Island Trusts.", "", "&b&lPermission", "%permission%")), IslandRank.MODERATOR);
    public Permission border = new Permission(new Item(XMaterial.BEACON, 30, 1, "&bIsland Border", Arrays.asList("&7Grant the ability to Change the Island border.", "", "&b&lPermission", "%permission%")), IslandRank.TRUSTED);
    public Permission spawnPortal = new Permission(new Item(XMaterial.OBSIDIAN, 31, 1, "&bSpawn Portal", Arrays.asList("&7Grant the ability to make a nether portal.", "", "&b&lPermission", "%permission%")), IslandRank.TRUSTED);
